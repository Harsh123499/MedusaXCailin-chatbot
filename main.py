...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","Sigmabot_support")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","Mr_harsh_zs2")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","Sigma_byz")
