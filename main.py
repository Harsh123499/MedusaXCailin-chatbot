...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","TEAM_DST")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","CODEX_MADARA")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","TEAM_DST")
